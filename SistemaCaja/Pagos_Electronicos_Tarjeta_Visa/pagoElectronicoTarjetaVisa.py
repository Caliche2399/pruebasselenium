...
chrome_options.set_capability('se:name','Prueba Pago Electronico Tarjeta Visa' )
...
class PagoElectronicoTarjetaVisa(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmDatosPago:tiposPago_5').click()
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_PagoElectronicoTarjetaVisa.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_PagoElectronicoTarjetaVisa.png')
