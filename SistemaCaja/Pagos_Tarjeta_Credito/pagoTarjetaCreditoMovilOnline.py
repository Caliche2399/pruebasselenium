...
chrome_options.set_capability('se:name','Prueba Pago Tarjeta Credito Movil Online' )
...
class PagoTarjetaCreditoMovilOnline(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmDatosFacturacion:itObservaciones').send_keys('OBSERVACIONES PAGO ONLINE MOVIL')
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_PagoTarjetaCreditoMovilOnline.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_PagoTarjetaCreditoMovilOnline.png')
