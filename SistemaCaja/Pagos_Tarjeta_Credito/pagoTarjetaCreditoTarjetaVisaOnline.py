...
chrome_options.set_capability('se:name','Prueba Pago Tarjeta Credito Tarjeta Debito Online' )
...
class PagoTarjetaCreditoTarjetaDebitoOnline(BaseCase):
    def runTest(self):  
        try:
            ...
            for opcion in listadoTabla:
                if(opcion.text == "TARJETA DE DEBITO LOCAL"):
                    opcion.click() 
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmDatosFacturacion:itObservaciones').send_keys('OBSERVACIONES PAGO ONLINE TARJETA DEBITO')
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_PagoTarjetaCreditoTarjetaDebitoOnline.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_PagoTarjetaCreditoTarjetaDebitoOnline.png')
