...
chrome_options.set_capability('se:name','Prueba Pago Tarjeta Credito Billetera Offline' )
...
class PagoTarjetaCreditoBilleteraOffline(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmDatosFacturacion:itObservaciones').send_keys('OBSERVACIONES PAGO OFFLINE BILLETERA')
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_PagoTarjetaCreditoBilleteraOffline.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_PagoTarjetaCreditoBilleteraOffline.png')
