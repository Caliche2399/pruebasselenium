...
chrome_options.set_capability('se:name','Prueba Pago Tarjeta Credito Internet Offline' )
...
class PagoTarjetaCreditoInternetOffline(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmDatosFacturacion:itObservaciones').send_keys('OBSERVACIONES PAGO OFFLINE INTERNET')
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_PagoTarjetaCreditoInternetOffline.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_PagoTarjetaCreditoInternetOffline.png')
