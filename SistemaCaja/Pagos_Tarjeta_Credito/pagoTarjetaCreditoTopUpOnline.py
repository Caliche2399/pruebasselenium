...
chrome_options.set_capability('se:name','Prueba Pago Tarjeta Credito TopUp Online' )
...
class PagoTarjetaCreditoTopUpOnline(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmDatosFacturacion:itObservaciones').send_keys('OBSERVACIONES PAGO ONLINE TOP UP')

            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='#frmInformacionCobro\:j_idt153 > div:nth-child(2)').click()
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_PagoTarjetaCreditoTopUpOnline.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_PagoTarjetaCreditoTopUpOnline.png')
