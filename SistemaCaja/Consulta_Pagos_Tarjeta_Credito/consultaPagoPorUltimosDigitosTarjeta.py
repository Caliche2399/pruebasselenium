...
ULTIMOS_DIGITOS = 'OSCAR'

#Configuración del driver
chrome_options = webdriver.ChromeOptions()
chrome_options.set_capability('se:name','Prueba Consulta Pago Tarjeta Credito Por Ultimos Digitos Tarjeta' )
...
class ConsultaPagoTarjetaCreditoPorUltimosDigitosTarjeta(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaPagos:ultimosDigitosTarjeta').send_keys(ULTIMOS_DIGITOS)
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_ConsultaPagoTarjetaCreditoPorUltimosDigitosTarjeta.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ConsultaPagoTarjetaCreditoPorUltimosDigitosTarjeta.png')
