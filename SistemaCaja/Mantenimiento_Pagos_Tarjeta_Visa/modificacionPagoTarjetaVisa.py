...
chrome_options.set_capability('se:name','Prueba Modificacion Pago Tarjeta Visa' )
...
class ModificacionPagoTarjetaVisa(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmMantenimientoPagos:tblResultados:cbModificar').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmModificaTmoDocumento:itaObservaciones').clear()

            sleep(0.5)
            driver.find_element(by= By.ID, value='frmModificaTmoDocumento:itaObservaciones').send_keys('MODIFICACION OBSERVACIONES PAGO TARJETA VISA SELENIUM')

            sleep(2)
            driver.find_element(by= By.ID, value='frmModificaTmoDocumento:btnGuardarCambios').click()


            #Se guarda un screenshot al terminar la prueba
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_ModificacionPagoTarjetaVisa.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ModificacionPagoTarjetaVisa.png')
