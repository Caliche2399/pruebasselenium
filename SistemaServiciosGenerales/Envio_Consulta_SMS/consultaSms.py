...
class consultaSMS(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='tabCuenta:frmBusquedaSms:btnBuscar').click()


            #Se guarda un screenshot al terminar la prueba
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_ConsultaSMS.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ConsultaSMS.png')
