...
class busquedaAvanzadaListaNegra(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:imCondicionanteTexto').send_keys(CLIENTE_UNICO)
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:cbAgregarValorBusquedaAvanzada').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaGtListaNegra:cbBuscar').click()


            #Se guarda un screenshot al terminar la prueba
            sleep(4)
            driver.save_screenshot('Prueba_Exitosa_BusquedaAvanzadaListaNegra.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaAvanzadaListaNegra.png')
