...
chrome_options.set_capability('se:name','Prueba Busqueda Restriccion')
...
class busquedaAvanzadaRestriccion(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:somCamposBusquedaAvanzada').click()

            sleep(5)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:somCamposBusquedaAvanzada_1').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:cbAgregarValorBusquedaAvanzada').click()
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Exitosa_BusquedaAvanzadaRestriccion.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaAvanzadaRestriccion.png')
