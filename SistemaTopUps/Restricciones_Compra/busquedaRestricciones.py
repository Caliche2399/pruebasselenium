...
class busquedaRestriccionesDeCompra(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(0.5)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:selOneMenuSistemaBusqueda').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:selOneMenuSistemaBusqueda_2').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:selOneMenuAplicacionBusqueda').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:selOneMenuAplicacionBusqueda_1').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaRestriccionRecarga:cbBuscar').click()

            #Se guarda un screenshot al terminar la prueba
            sleep(2)
            driver.save_screenshot('Prueba_Exitosa_BusquedaRestricciones.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaRestricciones.png')
