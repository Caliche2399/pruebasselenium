...
chrome_options.set_capability('se:name','Prueba Busqueda Por Estados Membresia' )
...
class busquedaPorEstados(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaMembresiaPorEstados.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaMembresiaPorEstados.png')
