...
class busquedaPorCodigoDistribuidor(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:txtDistribuidor').send_keys(CODIGO_DISTRIBUIDOR)
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaMembresiaPorDistribuidor.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaMembresiaPorDistribuidor.png')
