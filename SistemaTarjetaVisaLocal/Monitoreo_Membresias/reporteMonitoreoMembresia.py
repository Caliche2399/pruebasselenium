...
class reporteMonitoreoMembresia(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(30)
            driver.save_screenshot('Prueba_Exitosa_ReporteMonitoreoMembresia.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteMonitoreoMembresia.png')
