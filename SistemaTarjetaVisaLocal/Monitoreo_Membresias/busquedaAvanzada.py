...
chrome_options.set_capability('se:name','Prueba Busqueda Avanzada Membresia' )
...
class busquedaAvanzadaMembresia(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:camposBusquedaAvanzada_1').click()
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaMembresiaAvanzada.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaMembresiaAvanzada.png')
