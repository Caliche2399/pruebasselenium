...
class busquedaPorNumeroMembresia(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaMembresiaPorNumero.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaMembresiaPorNumero.png')
