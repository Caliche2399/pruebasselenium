...
chrome_options.set_capability('se:name','Prueba Reporte Por Estados Membresia' )
...
class reporteMonitoreoMembresiaPorEstados(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='div.ui-grid-row:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2)').click()
        
            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='div.ui-grid-row:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)').click()
        
            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='div.ui-grid-row:nth-child(4) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2)').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:btnBuscar').click()

            sleep(8)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:tvResultados:tblResultados:btnExportarBusqueda').click()

            sleep(80)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:tvResultados:tblResultados:btnDescargar').click()


            #Se guarda un screenshot al terminar la prueba
            sleep(20)
            driver.save_screenshot('Prueba_Exitosa_ReporteMembresiaPorEstados.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteMembresiaPorEstados.png')
