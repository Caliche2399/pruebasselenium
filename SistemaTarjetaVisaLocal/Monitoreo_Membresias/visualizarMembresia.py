...
NUMERO_MEMBRESIA = '782813781'

#Configuración del driver
chrome_options = webdriver.ChromeOptions()
chrome_options.set_capability('se:name','Prueba Visualización Membresia' )
...
class visualizarMembresia(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:tvResultados:tblResultados:btnVisualizar').click()


            #Se guarda un screenshot al terminar la prueba
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_VisualizacionMembresia.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_VisualizacionMembresia.png')
