...
chrome_options.set_capability('se:name','Prueba Reporte Monitoreo Solicitudes Por Estado')
...
class ReporteMonitoreoSolicitudesPorEstado(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:tvResultados:tblResultados:btnExportar').click()

            sleep(15)
            driver.find_element(by= By.CSS_SELECTOR, value='#primefacesmessagedlg > div:nth-child(1) > a:nth-child(2)').click()
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReporteMonitoreoSolicitudesPorEstado.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteMonitoreoSolicitudesPorEstado.png')
