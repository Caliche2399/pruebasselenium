...
chrome_options.set_capability('se:name','Prueba Busqueda Solicitud Por Estados')
...
class BusquedaSolicitudPorEstados(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='div.ui-grid-row:nth-child(5) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)').click()

            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='div.ui-grid-row:nth-child(6) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)').click()

            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='div.ui-grid-row:nth-child(7) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)').click()
            ...
            sleep(10)
            driver.save_screenshot('Prueba_Exitosa_BusquedaSolicitudPorEstados.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaSolicitudPorEstados.png')
