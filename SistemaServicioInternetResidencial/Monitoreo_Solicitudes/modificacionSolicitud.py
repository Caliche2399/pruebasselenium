...
NUMERO_SOLICITUD = '772378355'

#Configuración del driver
chrome_options = webdriver.ChromeOptions()
chrome_options.set_capability('se:name','Prueba Modificacion Solicitud' )
...
class ModificacionSolicitud(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_ModificacionSolicitud.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ModificacionSolicitud.png')
