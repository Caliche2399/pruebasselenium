...
chrome_options.set_capability('se:name','Prueba Busqueda Solicitud Por Numero' )
...
class BusquedaSolicitudPorNumero(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaSolicitudPorNumero.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaSolicitudPorNumero.png')
