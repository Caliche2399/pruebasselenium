...
chrome_options.set_capability('se:name','Prueba Busqueda Solicitud Por Administrador' )
...
class BusquedaSolicitudPorAdministrador(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:txtCodAdminCartera').send_keys(ADMINISTRADOR)
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaSolicitudPorAdministrador.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaSolicitudPorAdministrador.png')
