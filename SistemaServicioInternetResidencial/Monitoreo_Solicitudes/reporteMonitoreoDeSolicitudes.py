...
chrome_options.set_capability('se:name','Prueba Reporte Monitoreo Solicitudes')
...
class ReporteMonitoreoSolicitudes(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(30)
            driver.save_screenshot('Prueba_Exitosa_ReporteMonitoreoSolicitudes.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteMonitoreoSolicitudes.png')
