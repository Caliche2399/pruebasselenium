...
chrome_options.set_capability('se:name','Prueba Busqueda Solicitud Por Distribuidor' )
...
class BusquedaSolicitudPorDistribuidor(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:txtDistribuidor').send_keys(DISTRIBUIDOR)
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaSolicitudPorDistribuidor.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaSolicitudPorDistribuidor.png')
