...
chrome_options.set_capability('se:name','Prueba Busqueda Solicitud Avanzada')
...
class BusquedaSolicitudAvanzada(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:camposBusquedaAvanzada').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:camposBusquedaAvanzada_6').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:condicionanteDropDown').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:condicionanteDropDown_2').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmMonitoreoSolicitudes:btnAgregarValorBusquedaAvanzada').click()
            ...
            sleep(10)
            driver.save_screenshot('Prueba_Exitosa_BusquedaSolicitudAvanzada.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaSolicitudAvanzada.png')
