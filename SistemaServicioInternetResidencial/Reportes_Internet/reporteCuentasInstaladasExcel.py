...
chrome_options.set_capability('se:name','Prueba Reporte Cuentas Instaladas Excel' )
...
class ReporteCuentasInstaladasExcel(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReporteCuentasInstaladasExcel.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteCuentasInstaladasExcel.png')
