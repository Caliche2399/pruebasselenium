...
chrome_options.set_capability('se:name','Prueba Reporte Cuentas Instaladas Pdf' )
...
class ReporteCuentasInstaladasPdf(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReporteCuentasInstaladasPdf.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteCuentasInstaladasPdf.png')
