...
chrome_options.set_capability('se:name','Prueba Reporte Cuentas Reasignadas Excel' )
...
class ReporteCuentasReasignadasExcel(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='#frmReporteInternet\:formato > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(1) > div:nth-child(1) > div:nth-child(2)').click()
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReporteCuentasReasignadasExcel.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteCuentasReasignadasExcel.png')
