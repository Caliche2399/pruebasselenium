...
chrome_options.set_capability('se:name','Prueba Reporte Cuentas Reasignadas Csv' )
...
class ReporteCuentasReasignadasCsv(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='#frmReporteInternet\:formato > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(1) > div:nth-child(1) > div:nth-child(2)').click()
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReporteCuentasReasignadasCsv.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteCuentasReasignadasCsv.png')
