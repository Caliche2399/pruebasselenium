...
chrome_options.set_capability('se:name','Prueba Reporte Cuentas Instaladas Csv' )
...
class ReporteCuentasInstaladasCsv(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReporteCuentasInstaladasCsv.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteCuentasInstaladasCsv.png')
