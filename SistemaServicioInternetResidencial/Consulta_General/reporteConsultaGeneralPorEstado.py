...
chrome_options.set_capability('se:name','Prueba Reporte Consulta General Por Estado')
...
class ReporteConsultaGeneralPorEstado(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmResultadosBusqueda:tableResultadoCuentas:btnExportar').click()

            sleep(15)
            driver.find_element(by= By.CSS_SELECTOR, value='#primefacesmessagedlg > div:nth-child(1) > a:nth-child(2)').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmResultadosBusqueda:tableResultadoCuentas:btnDescargar').click()


            #Se guarda un screenshot al terminar la prueba
            sleep(20)
            driver.save_screenshot('Prueba_Exitosa_ReporteConsultaGeneralPorEstado.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteConsultaGeneralPorEstado.png')
