...
chrome_options.set_capability('se:name','Prueba Reporte Consulta General')
...
class ReporteConsultaGeneral(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(30)
            driver.save_screenshot('Prueba_Exitosa_ReporteConsultaGeneral.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteConsultaGeneral.png')
