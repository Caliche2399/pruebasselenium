...
NUMERO_CUENTA = '778551745'

#Configuración del driver
chrome_options = webdriver.ChromeOptions()
chrome_options.set_capability('se:name','Prueba BusquedaCuentaPorNumero' )
...
class BusquedaCuentaPorNumero(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaCuentaPorNumero.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaCuentaPorNumero.png')
