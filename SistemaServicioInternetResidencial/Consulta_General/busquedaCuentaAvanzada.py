...
chrome_options.set_capability('se:name','Prueba Busqueda Cuenta Avanzada')
...
class BusquedaCuentaAvanzada(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:camposBusquedaAvanzada').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:camposBusquedaAvanzada_1').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:condicionanteDropDown').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:condicionanteDropDown_5').click()

            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaAvanzada:btnAgregarValorBusquedaAvanzada').click()
            ...
            sleep(10)
            driver.save_screenshot('Prueba_Exitosa_BusquedaCuentaAvanzada.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaCuentaAvanzada.png')
