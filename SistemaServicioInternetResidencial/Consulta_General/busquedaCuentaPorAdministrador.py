...
chrome_options.set_capability('se:name','Prueba Busqueda Cuenta Por Administrador' )
...
class BusquedaCuentaPorAdministrador(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaGeneral:txtCodAdminCarteraBusqueda').send_keys(ADMINISTRADOR)
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaCuentaPorAdministrador.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaCuentaPorAdministrador.png')
