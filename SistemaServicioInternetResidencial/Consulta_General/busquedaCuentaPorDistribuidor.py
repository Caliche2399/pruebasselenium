...
chrome_options.set_capability('se:name','Prueba Busqueda Cuenta Por Distribuidor' )
...
class BusquedaCuentaPorDistribuidor(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmBusquedaGeneral:txtDistribuidorBusqueda').send_keys(DISTRIBUIDOR)
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_BusquedaCuentaPorDistribuidor.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_BusquedaCuentaPorDistribuidor.png')
