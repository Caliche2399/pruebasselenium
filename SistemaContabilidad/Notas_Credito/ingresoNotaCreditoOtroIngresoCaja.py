...
chrome_options.set_capability('se:name','Prueba Ingreso Nota Credito' )
...
class ingresoNotaCredito(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:itSerieDocumento').send_keys(SERIE)
        
            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:itNumeroDocumento').send_keys(NUMERO)
        
            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:panelFactura').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:somRazon').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:somRazon_4').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:itObservaciones').send_keys('PRUEBA NOTA CREDITO SELENIUM')
        
            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:inTotalNotaCredito').clear()

            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:inTotalNotaCredito').send_keys('10')
        
            sleep(2)
            driver.find_element(by= By.ID, value='tabViewPrincipal:frmNotaCredito:btnMostrarConfirmationDialog').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmConfirmacion:cmdProcesarNotaCredito').click()


            #Se guarda un screenshot al terminar la prueba
            sleep(8)
            driver.save_screenshot('Prueba_Exitosa_IngresoNotaDeCredito.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_IngresoNotaDeCredito.png')
