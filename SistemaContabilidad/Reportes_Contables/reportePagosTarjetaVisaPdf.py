...
class reportePagosTarjetaVisaPdf(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReportePagosTarjetaVisaPdf.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReportePagosTarjetaVisaPdf.png')
