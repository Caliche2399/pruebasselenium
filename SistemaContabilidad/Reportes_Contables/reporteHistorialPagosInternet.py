...
chrome_options.set_capability('se:name','Prueba Generacion Reporte Historial Pagos Internet' )
...
class reporteHistorialPagosInternet(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='formaDatos:seleccionPeriodo').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='formaDatos:seleccionPeriodo_3').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='formaDatos:seleccionMoneda').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='formaDatos:seleccionMoneda_2').click()
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReporteHistorialPagosInternet.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteHistorialPagosInternet.png')
