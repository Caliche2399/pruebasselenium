...
class consultaCuentasTarjetaRegalo(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmOmcConsulta:inMaskNumeroCliente').send_keys(CLIENTE_UNICO)
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmOmcConsulta:btnBuscar').click()
