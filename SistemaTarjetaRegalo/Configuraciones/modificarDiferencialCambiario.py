...
chrome_options.set_capability('se:name','Prueba Modificacion Diferencial Cambiario' )
...
class modificacionDiferencialCambiario(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.ID, value='frmOmcConfiguraciones:inMonedaDiferencialCambiario').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmOmcConfiguraciones:inMonedaDiferencialCambiario_2').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmOmcConfiguraciones:btnModificar').click()
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmOmcConfiguraciones:inMaskDiferencialCambiario').send_keys('7.50')
        
            sleep(2)
            driver.find_element(by= By.ID, value='frmOmcConfiguraciones:btnActualizarDiferencial').click()
