...
chrome_options.set_capability('se:name','Prueba Reporte Tarjetas Regalos Excel' )
...
class reporteVentasTarjetaRegaloExcel(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(5)
            driver.save_screenshot('Prueba_Exitosa_ReporteTarjetaRegaloExcel.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteTarjetaRegaloExcel.png')
...
def seleccionarAplicacionMenu():
    ...
    try:
        ...
        for aplicacionMenu in listadoMenu:
            if(aplicacionMenu.text == "REPORTE DE VENTAS DE TARJETAS DE REGALO"):
