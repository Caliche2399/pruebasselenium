...
chrome_options.set_capability('se:name','Prueba Reporte Tarjetas Regalos Pdf' )
...
class reporteVentasTarjetaRegaloPdf(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(15)
            driver.save_screenshot('Prueba_Exitosa_ReporteTarjetaRegaloPdf.png')
            ...
            sleep(2)
            driver.save_screenshot('Prueba_Fallida_ReporteTarjetaRegaloPdf.png')
