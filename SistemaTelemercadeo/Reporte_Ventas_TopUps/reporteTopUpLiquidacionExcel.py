...
class reporteVentasTopUpLiquidacionExcel(BaseCase):
    def runTest(self):  
        try:
            ...
            sleep(2)
            driver.find_element(by= By.CSS_SELECTOR, value='#formaDatos\:sorVersion > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(1) > div:nth-child(1) > div:nth-child(2)').click()
